    ...
    <div id="accordion" role="tablist">
      ...
      <div class="card-body">
         <?php $con=new mysqli("localhost","root","","hamrodookan");
           ...
           <a href="#"  onclick="GetUserDetails(<?php  echo $row['id']?>)" class="view-delete" data-toggle="modal" data-target="#update_user_modal">
           <i class="fa fa-pencil-square-o update-design">
           </i>
           </a>
           </span>
           <span><a href="" onclick="delete_message(<?php  echo $row['id']?>)" class="view-delete"><i class="glyphicon glyphicon-remove remove-design"></i></a></span><a href="<?php echo "#".$row['product_id']; ?> " class="mobiles-data-show"><?php echo $row['product_name']; ?></a></li>
           <?php
               }
            }
          ?>
          <li><a href="" class="btn btn-default inner-btn" data-toggle="modal" data-target="#add_new_record_modal">Add new</a></li>
      </div>
    </div>
  </div>
  <!-- Next heading -->
      ...
      <div class="card-body">
         <?php $con=new mysqli("localhost","root","","hamrodookan");
           ...
           <i class="fa fa-pencil-square-o update-design">
            ...
            <a href="<?php echo "#".$row['product_id']; ?> " class="mobiles-data-show"><?php echo $row['product_name']; ?></a></li>
           <?php
               }
            }
          ?>
          <li><a href="" class="btn btn-default inner-btn">Add new</a></li>
      </div>
    </div>
  </div>
</div>
             ...
             $sql="select *from hp_computer ";
                $result=$con->query($sql);
                  if($result->num_rows>0){
                    while ($row=$result->fetch_assoc()){
                       ?>
           <li><a href="<?php echo "#".$row['product_id']; ?> " class="computer-data-show"><?php echo $row['product_name']; ?></a></li>
           <?php
               }
            }
          ?>
